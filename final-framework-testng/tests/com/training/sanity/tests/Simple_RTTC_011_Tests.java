...
import com.training.pom.Simple_RTTC_011_POM;
import com.training.utility.DriverFactory;
import com.training.utility.DriverNames;

public class Simple_RTTC_011_Tests {
	private WebDriver driver;
	private String baseUrl;
	private Simple_RTTC_011_POM RTTC_011_POM;
	...
	public void setUpBeforeClass() throws IOException {
		extent = new ExtentReports(System.getProperty("user.dir")+"/REPORTS/Simple_RTTC_011_Tests.html", true); 
	...
	public void setUp() throws Exception {
		...
		RTTC_011_POM = new Simple_RTTC_011_POM(driver); 
	...
	public void RTTC_011_Test() {
		
		RTTC_011_POM.sendUserName("admin");
			try {
				Assert.assertEquals(RTTC_011_POM.userName.getAttribute("value"), Simple_RTTC_011_POM.expecteduserName);
		...
		RTTC_011_POM.sendPassword("admin@123");
		try {
			Assert.assertEquals(RTTC_011_POM.password.getAttribute("value"), Simple_RTTC_011_POM.expectedPassword);
		...
		RTTC_011_POM.clickLoginBtn();
		try {
			Assert.assertEquals(driver.getTitle(), Simple_RTTC_011_POM.expectedAdminPageTitle);
		...
		screenShot.captureScreenShot("Simple_RTTC_011");
